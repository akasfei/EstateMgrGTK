...
CC='gcc -mtune=pentium3 -mms-bitfields -mthreads' CPPFLAGS="-I/devel/dist/${ARCH}/${ZLIB}/include" LDFLAGS="-L/devel/dist/${ARCH}/${ZLIB}/lib" CFLAGS=-O2 ./configure --disable-static --enable-ft=no --prefix=c:/devel/target/$HEX &&
